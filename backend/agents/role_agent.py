...
_ROLES = [
    ...
    {
        "role": "Data Scientist",
        "core": ["python", "machine learning", "nlp", "pandas", "numpy"],
        "bonus": ["scikit-learn", "tensorflow", "pytorch", "hugging face", "huggingface",
                  "transformers", "rag", "sql", "r", "tableau", "spark", "deep learning"],
        ...
        "evidence_signals": {
            "skills": ["Python", "Pandas", "NumPy", "Scikit-learn", "Machine Learning", "NLP",
                       "HuggingFace", "Hugging Face", "Transformers", "SQL", "R"],
            "keywords": ["model", "dataset", "analysis", "prediction", "classification", "regression", "fine-tuned"],
        },
        "gap_checks": [
        ...
        "gap_labels": [
            ...
            "Deep learning / transformer framework not listed",
    ...
    {
        "role": "ML / AI Engineer",
        "core": ["python", "machine learning", "deep learning", "nlp", "llm"],
        "bonus": ["tensorflow", "pytorch", "hugging face", "huggingface", "transformers",
                  "langchain", "rag", "bert", "distilbert", "sentence transformers",
                  "scikit-learn", "docker", "aws", "fastapi", "computer vision"],
        "focus_areas": ["Model training & fine-tuning", "LLM & RAG pipelines", "MLOps & experiment tracking"],
        "probing": ["Distributed training", "Model serving at scale", "Prompt engineering & evaluation"],
        "evidence_signals": {
            "skills": ["TensorFlow", "PyTorch", "Machine Learning", "Deep Learning", "NLP", "LLM",
                       "HuggingFace", "Hugging Face", "LangChain", "RAG", "DistilBERT", "Gemini"],
            "keywords": ["neural network", "training", "inference", "model", "fine-tuning",
                         "transformer", "embedding", "rag", "llm", "agent"],
        },
        "gap_checks": [
            ("docker", "kubernetes"),
