...
_ALIASES: dict[str, list[str]] = {
    ...
    "llm":            ["llm", "large language models", "langchain", "llama", "gemini"],
    "huggingface":    ["huggingface", "hugging face", "hugging face transformers", "transformers"],
    "rag":            ["rag", "retrieval augmented generation", "retrieval-augmented generation"],
    "bert":           ["bert", "distilbert", "sentence transformers", "sentence-transformers"],
    "agentic":        ["agentic ai", "ai agents", "agent framework"],
    "opencv":         ["opencv", "cv2"],
